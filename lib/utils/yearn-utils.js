...
module.exports = function( config ){
	...
	yutils.constructYearningString = function( desired ){
		return ( desired.org === undefined ? '' : ( desired.org === '' ? '"default"' : desired.org ) + config.delimiters.org ) +
			( desired.module ) +
			( desired.version === undefined ? '' : config.delimiters.semver + desired.version ) +
			( desired.file === undefined ? '' : config.delimiters.file + desired.file );
	};
